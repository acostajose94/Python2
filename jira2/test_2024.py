...
def gestionar_ticket():
    ...
    # Esperar entre 8 y 11 minutos antes de cerrar el ticket
...
request_type_combo['values'] = ('Saldo','Pago', 'Base','Reportes')
request_type_combo.grid(row=1, column=1, padx=10, pady=10)

# Botón para gestionar ticket
ttk.Button(root, text="Crear y cerrar ticket", command=gestionar_ticket).grid(row=2, columnspan=2, pady=20)
