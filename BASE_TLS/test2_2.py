...
indice_email2 = nombres_columnas.index('EMAIL2')
indice_email3 = nombres_columnas.index('EMAIL3')
indice_email4 = nombres_columnas.index('EMAIL4')
# Escribir los encabezados en la hoja de resultado
hoja_resultado['A1'] = "EMPLID"
hoja_resultado['B1'] = "EMAILS"
...
for fila in hoja_trabajo.iter_rows(min_row=2, values_only=True):
    ...
    email2 = fila[indice_email2]
    email3 = fila[indice_email3]
    email4 = fila[indice_email4]

    if email2:
        filas_no_vacias.append((emplid, email2))

    if email3:
        filas_no_vacias.append((emplid, email3))
    
    if email4:
        filas_no_vacias.append((emplid, email4))
